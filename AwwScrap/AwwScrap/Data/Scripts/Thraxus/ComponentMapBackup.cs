...
//namespace AwwScrap
//{
//	public class ComponentMapBackup
//	{
...
//			try
//			{
//				MyBlueprintDefinitionBase _scrapBlueprintDefinition = MyDefinitionManager.Static.GetBlueprintDefinition(new MyDefinitionId(typeof(MyObjectBuilder_BlueprintDefinition), _componentDefinition.Id.SubtypeName + ScrapSuffix + ScrapBpSuffix));
...
//				};
//				_scrapBlueprintDefinition.Init(scrapBpOb, _modContext);
...
//		//private void GenerateScrapBlueprint2()
//		//{
//		//	if (_scrapDefinition == null) return;
//		//	if (CompatibleBlueprints.Count <= 0) return;
...
//		//			Prerequisites = new MyBlueprintDefinitionBase.Item[scrapBpOb.Prerequisites.Length]
//		//		};

//		//		for (int i = 0; i < _scrapBlueprintDefinition.Prerequisites.Length; ++i)
//		//		{
//		//			_scrapBlueprintDefinition.Prerequisites[i] = MyBlueprintDefinitionBase.Item.FromObjectBuilder(scrapBpOb.Prerequisites[i]);
//		//		}
//		//		if (scrapBpOb.Result != null)
//		//		{
//		//			_scrapBlueprintDefinition.Results = new MyBlueprintDefinitionBase.Item[1];
//		//			_scrapBlueprintDefinition.Results[0] = MyBlueprintDefinitionBase.Item.FromObjectBuilder(scrapBpOb.Result);
//		//		}
//		//		else
//		//		{
//		//			_scrapBlueprintDefinition.Results = new MyBlueprintDefinitionBase.Item[scrapBpOb.Results.Length];
//		//			for (int i = 0; i < _scrapBlueprintDefinition.Results.Length; ++i)
//		//			{
//		//				_scrapBlueprintDefinition.Results[i] = MyBlueprintDefinitionBase.Item.FromObjectBuilder(scrapBpOb.Results[i]);
//		//			}
//		//		}
...
//			}
//			//MyDefinitionManager.Static.Definitions.Definitions[_scrapBlueprintDefinition.GetType()].Add(_scrapBlueprintDefinition.Id.SubtypeId, _scrapBlueprintDefinition);
//			//MyDefinitionManager.Static.PreloadDefinitions();
//			//MyDefinitionManagerBase.Static.Definitions.AddOrRelaceDefinition(_scrapBlueprintDefinition);
//			//MyDefinitionManager.Static.Definitions.Definitions.Add(_scrapBlueprintDefinition.GetType(), new Dictionary<MyStringHash, MyDefinitionBase> { { _scrapBlueprintDefinition.Id.SubtypeId, _scrapBlueprintDefinition } });
//		}
